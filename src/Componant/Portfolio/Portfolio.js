    ...
    <div className="lg:ml-[200px] md:ml-0 sm:ml-0 bg-midnight font-[poppins]">
        ...
        <div style={{backgroundImage: `url(${mainBg})`, backgroundRepeat:`no-repeat`, objectFit: 'cover',}} 
         className="w-full lg:h-screen md:h-full relative text-center flex flex-col overflow-hidden items-center justify-center gap-2">
          ...
          <h1 className="lg:text-[35px] sm:mt-24 md:mt-24 sm:text-[25px] sm:my-6 text-white font-bold ">My Development Work</h1>
          ...
          <div className="flex flex-wrap gap-10 sm:mb-8 z-20 items-center text-center justify-center">
            <div className="lg:h-[250px] lg:w-[450px] z-10 sm:h-[250px] sm:w-[320px] relative hover:scale-110 transition-all duration-200 cursor-pointer gap-3 flex-col  ring-1 ring-mycolor2 bg-DarkBlue rounded-sm flex justify-center items-center">
